...
function App() {
  ...
  // Verify the real server-side session on load instead of trusting
  // whatever isLoggedIn/role happen to be sitting in localStorage —
  // that cache goes stale the moment a cookie expires or is cleared.
  useEffect(() => {
